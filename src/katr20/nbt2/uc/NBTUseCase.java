...
public class NBTUseCase {
	...
	/*
	 * Create an NBTLibrary object using a path to the file "test" and don't
	 * read all the tags from the file, hence the boolean being false.
	 * This'll make it so the library is essentially empty.
	 */
	NBTLibrary lib = new NBTLibrary("test", false);
	/*
	 * Even though we ignored reading the tags upon instantiation, we'll
	 * read them now, just to show it off.
	 */
	lib.readTags();
